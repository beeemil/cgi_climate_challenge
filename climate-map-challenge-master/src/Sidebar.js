...
const Graph = (dailyWeather) => {
    ...
    return(
        <ComposedChart width = {320} height = {200} data = {data} margin = {margin}>
            <XAxis dataKey = "date"/>
            <YAxis yAxisId = "right" orientation = "right" label = {{value : 'Rain (mm)', angle: -90}} tickFormatter = {BarFormatter}/>
            <YAxis yAxisId = "left" label = {{value : 'Temp', angle: -90}}/>
            <Bar name = "Accumulated rain" dataKey = "accrain" barSize = {20} fill = "#A3BCEC" yAxisId = "right">
